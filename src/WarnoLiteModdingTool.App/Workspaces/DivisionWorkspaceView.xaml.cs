...
public partial class DivisionWorkspaceView : UserControl
{
    ...
    private void DivisionFilter_Changed(object? sender, EventArgs e)
    { if(sender is WarnoLiteModdingTool.App.Controls.FacetFilter f && DataContext is WarnoLiteModdingTool.App.ViewModels.MainViewModel m && m.DivisionWorkspace is {} vm) { vm.DivisionFilter=f.Matches;vm.DivisionsView.Refresh(); } }
