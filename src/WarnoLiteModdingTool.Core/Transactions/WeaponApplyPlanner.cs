...
public sealed class WeaponApplyPlanner
{
    ...
    {
        if (operations.Any(o => o.TargetKind == DraftTargetKind.WeaponBatch || Batch.AmmoBatchPlanner.IsBatch(o))) return WeaponBatchApplyPlanner.Plan(units, workspace, operations, getSnapshot);
